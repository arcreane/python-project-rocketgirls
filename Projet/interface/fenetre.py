from PySide6.QtWidgets import QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QListWidget, QGroupBox, QSpinBox, QFrame, QMessageBox
...
class FenetrePrincipale(QMainWindow):
    def __init__(self, simulation):
        ...
        self.setWindowTitle("Simulateur de Contrôle Aérien")
    ...
    def creer_panel_gauche(self):
        ...
        for label in [self.label_temps, self.label_score, self.label_avions, self.label_atterrissages, self.label_collisions, self.label_etat_simulation]:
    ...
    def creer_panel_droit(self):
        ...
        self.spin_altitude.setRange(0, 1000000)
        ...
        for btn, cap in [(self.btn_cap_0, 0), (self.btn_cap_90, 90), (self.btn_cap_180, 180), (self.btn_cap_270, 270)]:
        ...
        self.spin_vitesse.setRange(0, 10000)
    ...
    def activer_controles(self):
        for widget in [self.btn_monter, self.btn_descendre, self.btn_cap_0, self.btn_cap_90, self.btn_cap_180, self.btn_cap_270,
                       self.spin_cap, self.btn_appliquer_cap, self.btn_accelerer, self.btn_ralentir, self.btn_atterrir,
                       self.btn_attente, self.btn_stop_attente, self.btn_urgence, self.spin_altitude,
